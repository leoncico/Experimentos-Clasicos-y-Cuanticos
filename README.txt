...
LIBRERÍA DE EXPERIMENTOS CLÁSICOS Y CUANTICOS

En la librería encontrará Experimentos Probabilísticos con canicas y con doble rendija y un Experimento 
cuántico con doble rendija

Para obtener una copia del proyecto es necesario dirigirse al link del repositorio (https://github.com/leoncico/Experimentos-Clasicos-y-Cuanticos) y descargar todos los archivos publicados.
...
1. Dijirase al link del repositorio: https://github.com/leoncico/Experimentos-Clasicos-y-Cuanticos
2. Pulse el botón “Code” de color verde.
3. Seleccione la opción “Download ZIP”
4. Descomprima el .ZIP y ejecute el archivo .py

Ejecutando las pruebas.
Si desea realizar pruebas en la librería dirijase al archivo Clasico a Cuantico.py y allí podrá modificar valores
del experimento como por ejemplo la matriz asociada, el vector inicial y el número de tics al que se desee
observar.
